...
{
    public class SillyParkingBoy : ParkingBoy
    {
        private List<ParkingLots> parkingLots;

        public SillyParkingBoy(List<ParkingLots> parkingLots, ParkingLots parkingLot) : base(parkingLot)
        {
        ...
        public Ticket ParkingCar(Car car)
        {
            ...
            return storageParkingLot.StorageCar(car);
        }
    }
}
